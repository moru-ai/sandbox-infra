...
import (
	...
	"github.com/moru-ai/sandbox-infra/packages/api/internal/middleware/otel/tracing"
...
var tracer = otel.Tracer("github.com/moru-ai/sandbox-infra/packages/api/internal/handlers")
