...
func TestGetTargetFromRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			host:      "49983-isv6ril5xadwn1k9t2jye-6532622b.moru.app",
		...
		},
		{
			...
			host:      "49983-isv6ril5xadwn1k9t2jye-6532622b.moru-test.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
			wantErrIs: nil,
		},
		{
			...
			host:      "49983-isv6ril5xadwn1k9t2jye-6532622b.demo.moru.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
			wantErrIs: nil,
		},
		{
			...
			host:      "49983-isv6ril5xadwn1k9t2jye.moru.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
			wantErrIs: nil,
		},
		{
			...
			host:      "49983-isv6ril5xadwn1k9t2jye.moru-test.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
			wantErrIs: nil,
		},
		{
			...
			host:      "49983-isv6ril5xadwn1k9t2jye.demo.moru.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
			wantErrIs: nil,
		},
		{
			...
			host:      "isv6ril5xadwn1k9t2jye.moru.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
		...
		},
		{
			...
			host:      "abcd-isv6ril5xadwn1k9t2jye.moru.app",
			wantID:    "isv6ril5xadwn1k9t2jye",
			wantPort:  49983,
