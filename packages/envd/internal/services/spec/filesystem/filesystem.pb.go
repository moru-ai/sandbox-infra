...
const file_filesystem_filesystem_proto_rawDesc = "" +
	...
	"\rRemoveWatcher\x12 .filesystem.RemoveWatcherRequest\x1a!.filesystem.RemoveWatcherResponseB\xbb\x01\n" +
	"\x0ecom.filesystemB\x0fFilesystemProtoP\x01ZPgithub.com/moru-ai/sandbox-infra/packages/envd/internal/services/spec/filesystem\xa2\x02\x03FXX\xaa\x02\n" +
	"Filesystem\xca\x02\n" +
